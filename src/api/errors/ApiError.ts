...
import { env } from '../../env';
import {
    AccessTokenErrorResponse, AuthFailureResponse, BadRequestResponse, ForbiddenResponse,
    InternalErrorResponse, NotFoundResponse
} from './ApiResponse';
...
export abstract class ApiError extends Error {
  ...
  public handle(err: ApiError, res: Response): Response {
    switch (err.type) {
